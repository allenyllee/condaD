...
#apt update && apt-get install -y build-essential cmake libboost-python-dev pkg-config

# dependencies for X11 GUI window
#apt update && apt-get install -y libx11-dev

# dependencies for ??
#apt update && apt-get install -y libatlas-base-dev libgtk-3-dev
